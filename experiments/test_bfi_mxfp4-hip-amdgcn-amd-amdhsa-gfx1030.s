...
; %bb.1:
	...
	v_and_b32_e32 v3, 0x7070707, v3
	v_perm_b32 v6, s0, 0x3020100, v4
	v_and_b32_e32 v5, 0x1010101, v5
	v_and_b32_e32 v2, 0x1010101, v2
	v_perm_b32 v4, s1, 0xfdfeff00, v4
	v_perm_b32 v7, s0, 0x3020100, v3
	v_perm_b32 v3, s1, 0xfdfeff00, v3
	v_perm_b32 v5, 0xff00, 0xff00, v5
	v_perm_b32 v8, 0xff00, 0xff00, v2
	;;#ASMSTART
	v_bfi_b32 v2, v5, v4, v6
	;;#ASMEND
	;;#ASMSTART
	v_bfi_b32 v3, v8, v3, v7
	;;#ASMEND
...
.Lfunc_end0:
	.size	_Z8test_bfiPKjP15HIP_vector_typeIiLj2EEi, .Lfunc_end0-_Z8test_bfiPKjP15HIP_vector_typeIiLj2EEi
                                        ; -- End function
	.set _Z8test_bfiPKjP15HIP_vector_typeIiLj2EEi.num_vgpr, 9
...
; %bb.1:
	...
	v_perm_b32 v6, s0, 0x3020100, v4
	v_perm_b32 v4, s1, 0xfdfeff00, v4
	v_and_or_b32 v5, v5, s4, 0x3020100
	v_and_or_b32 v7, v2, s4, 0x3020100
	v_perm_b32 v8, s0, 0x3020100, v3
	v_perm_b32 v3, s1, 0xfdfeff00, v3
	v_perm_b32 v2, v4, v6, v5
...
.Lfunc_end1:
	.size	_Z13test_baselinePKjP15HIP_vector_typeIiLj2EEi, .Lfunc_end1-_Z13test_baselinePKjP15HIP_vector_typeIiLj2EEi
                                        ; -- End function
	.set _Z13test_baselinePKjP15HIP_vector_typeIiLj2EEi.num_vgpr, 9
